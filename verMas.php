			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="filtro.php?var1=Nuevo&var2=all&var3=all">Lo más nuevo</a></li>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<br><h1> Inicie sesión si quiere agendar una cita.</h1>
							</div>
							
							<div class="add-to-cart">
							
											
                             <?php  echo '<a href="registroUsuario.php">'; ?>
				            <button class="add-to-cart-btn">Registrarse</button>
