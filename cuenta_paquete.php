			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						...
						<li><a href="cuenta.php"><i class="fa fa-user-o"></i> <?php echo ''.$_SESSION['usuario2']. ''; ?> </a></li>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="cuenta_paquete.php">Paquetes</a></li>
						<li><a href="cuenta_subs.php">Historial</a></li>
					</ul>
					<!-- /NAV -->
				</div>
				<!-- /responsive-nav -->
...
<center>
            ...
            $all2 = "SELECT * FROM	clientes WHERE idclientes='$id'";
            $eje2 = mysqli_query($conect, $all2);
            $listaT2 = mysqli_fetch_array($eje2); 
            $id2= $listaT2['idpaquetes'];
            //seleccionamos el paquete del cliente
            $all = "SELECT * FROM clientes inner join paquetes on clientes.idpaquetes=paquetes.idpaquetes 
            WHERE  paquetes.idpaquetes= '$id2'";
            $eje = mysqli_query($conect, $all);
            $listaT = mysqli_fetch_array($eje); 
            //seleccionamos la sub del cliente
            $all3 = "SELECT * FROM subscriptor  WHERE  idclientes= '$id'";
            $eje3 = mysqli_query($conect, $all3);
            $listaT3 = mysqli_fetch_array($eje3); 
            	//las mostramos
            if($id2==0){
			?>
            
			<h2>No tiene ningun paquete en su cuenta.</h2>
			<h3>¿Quiere adquirir alguno? Consulte aquí</h3><i class="far fa-hand-point-right"></i><a href="index2_package.php">  Paquetes </a><i class="far fa-hand-point-left"></i>
            <?php 
			}else{
            ?>
            <div class="conte" style="width: 500px">
				<div class="flex-container">
		            <div class="flex-item">
					    <ul class="package">
					      <li class="header"><?php echo$listaT['nombreP']; ?></li>
					      <li class="gray"> <?php echo$listaT['meses']; ?> meses</li>
					      <li class="gray">Precio: <?php echo$listaT['precio']; ?></li>
					      <li class="gray">Fecha: <?php echo$listaT3['FechaCompra']; ?></li>
					      <li class="gray">Expira:<?php echo$listaT3['FechaVencimiento']; ?></li>
					      <li class="gray">Casas:<?php echo$listaT['casasP']; ?></li>
					      <li class="gray">
					      <?php  echo '<a href="index2.php">'; ?>
