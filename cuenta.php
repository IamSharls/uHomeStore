...
.th, td{
			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						...
						<li><a href="#"><i class="fa fa-user-o"></i> <?php echo ''.$_SESSION['usuario2']. ''; ?> </a></li>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						<li class="active"><a href="cuenta.php">Solicitudes</a></li>
    ...
    <br>
    <?php
                                //seleccionamos las propiedades del cliente
     ...
     $si = "SELECT * FROM inmobilaria WHERE clientes_idclientes = '$id'";
     $con = mysqli_query($conect, $si);
     if(mysqli_num_rows($con) > 0){                           
     if($subscriptor == false){
         $cam = "UPDATE inmobilaria SET status = 'REVISION', comentarios = 'Tu suscripción ha terminado, renuevala o se eliminarán tus propiedades' WHERE clientes_idclientes = '$id'";
         $si2 = mysqli_query($conect, $cam);
         $cam2 = "UPDATE clientes SET idpaquetes = '0' WHERE idclientes = '$id'";
         $si3 = mysqli_query($conect, $cam2);
         
     }   
     }
     $all = "SELECT * FROM inmobilaria WHERE clientes_idclientes = '$id'";
...
//las mostramos
                ...
                echo"<td class=\"td\">";    
                echo '<a href="modificarCasaCliente.php?var2='.$k3.'">';
                echo '<button >';
                echo 'Modificar';
                echo '</button>';
                echo '</a>';
                ...
                $k3 = $listaT["idinmobiliaria"];    
                echo"<td class=\"td\">";    
                echo '<a href="verDatos.php?var2='.$k3.'">';
                echo '<button >';
                echo 'Ver';
                echo '</button>';
                echo '</a>';
