	...
	<body>
		...
		<?php
            ...
            if(isset($_POST['save'])){
               ...
               /* $up = "UPDATE inmobilaria SET nombreIn = '$nombres', descripcionIn = '$descripcion', direccionIn = '$direccion', precioIn = '$precio', etiqueta1 = '$et1', etiqueta2='$et2', etiqueta3 = '$et3', etiqueta4 = '$et4', etiqueta5 = '$et5', status = 'REVISION' ,comentarios = '$comen' WHERE idinmobiliaria = '$id'";*/
                $up = "UPDATE inmobilaria SET comentarios = '$comen' WHERE idinmobiliaria = '$id'";
				$updatee = mysqli_query($conect, $up);
                
				if($updatee){
					header("Location: modificarCasa.php?var2=".$id."&suc=succ");
				}else{
		...
		<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-1">
						<input type="text" name="codigo" value="<?php echo $row ['idinmobiliaria']; ?>" class="form-control" placeholder="ID" disabled>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">Nombre</label>
					<div class="col-sm-4">
						<input type="text" name="nombres" value="<?php echo $row ['nombreIn']; ?>" class="form-control" placeholder="Nombre" required disabled>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">Descripción</label>
					<div class="col-sm-6">
						<input type="text" name="desc" value="<?php echo $row ['descripcionIn']; ?>" class="form-control" placeholder="Descripción" required disabled>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">Dirección</label>
					<div class="col-sm-3">
						<input type = "text" name="direccion" class="form-control" value = "<?php echo $row ['descripcionIn']; ?>" placeholder="Dirección" disabled>
					</div>
               </div>
               <div class="form-group">
					<label class="col-sm-2 control-label">Precio</label>
					<div class="col-sm-3">
						<input type = "text" name="precio" class="form-control" value = "<?php echo $row ['precioIn']; ?>" placeholder="Precio" disabled>
					</div>
               </div>
				<div class="form-group">
					<label class="col-sm-2 control-label">Etiqueta 1</label>
					<div class="col-sm-3">
						<select name="et1" class="form-control" disabled>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="et2" class="form-control" disabled>
							<option value="">- Selecciona estado -</option>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="et3" class="form-control" disabled>
							<option value="">- Selecciona estado -</option>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="et4" class="form-control" disabled>
							<option value="">- Selecciona estado -</option>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="et5" class="form-control" disabled>
							<option value="">- Selecciona estado -</option>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="desc" value="<?php echo $row ['status']; ?>" class="form-control" placeholder="Nombre" required disabled >
					</div>
				</div>
                <div class="form-group">
					<label class="col-sm-2 control-label">Comentarios</label>
					<div class="col-sm-6">
						<input type="text" name="comen" value="<?php echo $row ['comentarios']; ?>" class="form-control" placeholder="Nombres" required>
					</div>
				</div>
